  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h5>Services</h5>
        <ul>
          <li><a href="<?= site_url('services') ?>#software-development">Software Development</a></li>
          <li><a href="<?= site_url('services') ?>#it-consulting">IT Consulting &amp; Strategy</a></li>
          <li><a href="<?= site_url('services') ?>#cloud-solutions">Cloud Solutions</a></li>
          <li><a href="<?= site_url('services') ?>#cybersecurity">Cybersecurity</a></li>
          <li><a href="<?= site_url('services') ?>#managed-it">Managed IT Support</a></li>
        </ul>
      </div>
      ...
      <div class="footer-col">
        ...
        <div class="contact-line">
          ...
          <span>Veivauceva, 6 Miles, Tacirua, Fiji</span>
        </div>
        <div class="contact-line">
          ...
          <span>9896700 / 7829063</span>
        </div>
        <div class="contact-line">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z" opacity="0"></path><path d="M22 6l-10 7L2 6"></path><rect x="2" y="4" width="20" height="16" rx="2"></rect></svg>
          <span>info@precisiontechfiji.com</span>
        </div>
      </div>
    </div>

    <div class="footer-bottom">
      <span>&copy; <?= date('Y') ?> Precision Tech Pte Ltd. All rights reserved.</span>
      <span>Designed &amp; built in Fiji.</span>
    </div>
  </div>
</footer>

<button class="to-top" aria-label="Back to top">
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 15l-6-6-6 6"></path></svg>
</button>
